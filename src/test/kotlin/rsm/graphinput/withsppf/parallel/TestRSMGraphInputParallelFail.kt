...
class TestRSMGraphInputParallelFail {
    @Test
    fun `test 'empty' hand-crafted grammar`() {
        ...
        assertEquals(expected = hashMapOf(), actual = GLL(rsmState0, listOf(graph)).parse().toMap())
    }
    ...
    fun `test 'a' hand-crafted grammar`(input: String) {
        ...
        assertEquals(
            expected = hashMapOf(), actual = GLL(rsmState0, listOf(readGraphFromString(input))).parse().toMap())
    }
    ...
    fun `test 'ab or cd' ambiguous hand-crafted grammar`(input: String) {
        ...
        assertEquals(expected = hashMapOf(), actual = GLL(rsmState0, listOf(graphNode0)).parse().toMap())
    }
    ...
    fun `test 'dyck' hand-crafted grammar two cycle graph`() {
        ...
        assertEquals(expected = hashMapOf(), actual = GLL(rsmState0, listOf(graphNode3)).parse().toMap())
    }
    ...
    fun `test 'a-plus' hand-crafted grammar one cycle graph`() {
        ...
        assertEquals(expected = hashMapOf(), actual = GLL(rsmState0, listOf(graphNode0)).parse().toMap())
        assertEquals(expected = hashMapOf(), actual = GLL(rsmState0, listOf(graphNode1)).parse().toMap())
    }
    ...
    fun `test 'g1' hand-crafted grammar two cycle graph`() {
        ...
        assertEquals(
            expected = hashMapOf(),
            actual = GLL(rsmState0, listOf(graphNode0, graphNode1, graphNode2, graphNode3)).parse().toMap())
    }
}
